...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/asyncstdlib-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13436&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/asyncstdlib-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `asyncstdlib` can be installed with:

```
conda install asyncstdlib
```

It is possible to list all of the versions of `asyncstdlib` available on your platform with:
